  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">校园管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxifangshi" autocomplete="off" placeholder="联系方式" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.danweileibie" class="input" type="text" placeholder="单位类别">
			   </div>
			 </div> -->
			<el-form-item label="单位类别" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.danweileibie" autocomplete="off" placeholder="单位类别" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='yuanxiaoguanliyuan'" class="input-group">
			   <div class="label">院校账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yuanxiaozhanghao" class="input" type="text" placeholder="院校账号">
			   </div>
			 </div> -->
			<el-form-item label="院校账号" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
			  <el-input v-model="ruleForm.yuanxiaozhanghao" autocomplete="off" placeholder="院校账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuanxiaoguanliyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuanxiaoguanliyuan'" class="input-group">
			...
			<el-form-item label="负责人姓名" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuanxiaoguanliyuan'" class="input-group">
			   <div class="label">联系方式</div>
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
			  <el-input v-model="ruleForm.lianxifangshi" autocomplete="off" placeholder="联系方式" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yuanxiaoguanliyuan'" class="input-group">
			...
			<el-form-item label="备注" class="input" v-if="tableName=='yuanxiaoguanliyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                if((!this.ruleForm.yuanxiaozhanghao) && `yuanxiaoguanliyuan` == this.tableName){
        this.$message.error(`院校账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `yuanxiaoguanliyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                    if(`yuanxiaoguanliyuan` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
