      ...
      <el-row>
          ...
          <el-form-item class="input" label="学院名称" prop="xueyuanmingcheng">
              <el-input v-model="ruleForm.xueyuanmingcheng" 
                placeholder="学院名称" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资料文件" prop="ziliaowenjian">
          <file-upload
          tip="点击上传资料文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaowenjian" label="资料文件" prop="ziliaowenjian">
            <el-button type="text" size="small" @click="download(ruleForm.ziliaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职工人数" prop="zhigongrenshu">
          <el-input v-model="ruleForm.zhigongrenshu" 
              placeholder="职工人数" clearable  :readonly="ro.zhigongrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职工人数" prop="zhigongrenshu">
              <el-input v-model="ruleForm.zhigongrenshu" 
                placeholder="职工人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="院校账号" prop="yuanxiaozhanghao">
          <el-select v-model="ruleForm.yuanxiaozhanghao" placeholder="请选择院校账号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="院校账号" prop="yuanxiaozhanghao">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuanjianjie = true;
            continue;
	            	            ...
	            	            if(o=='zhigongrenshu'){
            this.ruleForm.zhigongrenshu = obj[o];
	    this.ro.zhigongrenshu = true;
            continue;
          }
