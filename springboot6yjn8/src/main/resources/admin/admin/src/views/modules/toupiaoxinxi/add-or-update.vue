<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="候选人姓名" prop="houxuanrenxingming">
          <el-input v-model="ruleForm.houxuanrenxingming" 
              placeholder="候选人姓名" clearable  :readonly="ro.houxuanrenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="候选人姓名" prop="houxuanrenxingming">
              <el-input v-model="ruleForm.houxuanrenxingming" 
                placeholder="候选人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
                placeholder="年龄" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="赞成票" prop="zanchengpiao">
          <el-input v-model="ruleForm.zanchengpiao" 
              placeholder="赞成票" clearable  :readonly="ro.zanchengpiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="赞成票" prop="zanchengpiao">
              <el-input v-model="ruleForm.zanchengpiao" 
                placeholder="赞成票" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="反对票" prop="fanduipiao">
          <el-input v-model="ruleForm.fanduipiao" 
              placeholder="反对票" clearable  :readonly="ro.fanduipiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="反对票" prop="fanduipiao">
              <el-input v-model="ruleForm.fanduipiao" 
                placeholder="反对票" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='houxuanrenxingming'){
            this.ruleForm.houxuanrenxingming = obj[o];
	    this.ro.houxuanrenxingming = true;
            continue;
          }
	            	            if(o=='xingbie'){
	    ...
	    this.ro.gerenjieshao = true;
            continue;
	            	            ...
	            	            if(o=='zanchengpiao'){
            this.ruleForm.zanchengpiao = obj[o];
	    this.ro.zanchengpiao = true;
            continue;
          }
	            	            if(o=='fanduipiao'){
            this.ruleForm.fanduipiao = obj[o];
	    this.ro.fanduipiao = true;
            continue;
          }
	            	            if(o=='gengxinshijian'){
